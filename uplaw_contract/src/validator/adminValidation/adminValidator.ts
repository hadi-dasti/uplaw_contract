...
export const adminUpdateValidation = (req: Request, res: Response, next: NextFunction) => {
...
export const validationAdminId = (req: Request, res: Response, next: NextFunction) => {
    //define id 
    const adminValidateId = Joi.object({
